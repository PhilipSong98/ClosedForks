...
import { CUISINES } from '@/data/mock';
...
const CuisineFilters: React.FC<CuisineFiltersProps> = ({ selectedCuisines, onCuisineToggle, sortBy, onSortChange }) => {
        ...
        {CUISINES.map((cuisine) => {
          ...
          return (
            <button
              ...
              className={`cuisine-filter-chip ${
                isSelected ? 'cuisine-filter-chip-selected' : 'cuisine-filter-chip-default'
              }`}
            >
              {cuisine}
              {isSelected && (
