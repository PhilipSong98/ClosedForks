...
-- Adds full_name field to users table and creates invite_codes table for 6-digit code system

-- ============================================================================
-- UPDATE USERS TABLE - ADD FULL_NAME
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS invite_codes (
    ...
    created_by UUID REFERENCES users(id) ON DELETE SET NULL, -- Who created this code
...
ADD CONSTRAINT check_uses_not_exceeded 
...
CREATE TABLE IF NOT EXISTS invite_code_usage (
    ...
    UNIQUE(invite_code_id, user_id) -- Prevent duplicate usage by same user
);
...
-- Index for expiration dates (without NOW() function to avoid immutable function requirement)
...
-- Create trigger for updated_at on invite_codes
