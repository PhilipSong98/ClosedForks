  ...
  public: {
    Tables: {
      invite_code_usage: {
        ...
        Relationships: [
          {
            foreignKeyName: "invite_code_usage_invite_code_id_fkey"
          ...
          {
            foreignKeyName: "invite_code_usage_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      restaurants: {
        Row: {
          ...
          source: Database["public"]["Enums"]["restaurant_source"] | null
      ...
      to_eat_list: {
        ...
        Relationships: [
          {
            foreignKeyName: "to_eat_list_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_restaurant_with_avg: {
        Args: { restaurant_id: string; viewer_id?: string }
        Returns: {
          address: string
          avg_rating: number
          booking_url: string
    ...
    Enums: {
      ...
      visibility_type: "my_circles" | "public"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
